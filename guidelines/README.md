...
- [Add experimental flag](./skills/add-experimental-flag/SKILL.md) - Register and implement new experimental feature flags
...
| **"add an experimental flag"** / **"implement a feature flag"** / **"register experimental option"** | Follow `guidelines/skills/add-experimental-flag/SKILL.md` to register the flag, update defaults, and add tests. |
