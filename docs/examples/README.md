...
- **[toolPluginSkillWorkflowPoc.js](toolPluginSkillWorkflowPoc.js)** - POC: add-docs-links skill as two tools (entry + step workflow); workflow steps parsed from `SKILL.md` (`## Workflow`); `patternfly://skills/{id}` previews and full bodies via MCP resources
