...
- **Experimental options** - When an option is registered as experimental, use `--experimental-<kebab-name>` on the CLI, for programmatic options use `experimental<PascalName>`.
...
#### Notes
- **Experimental options** - When an option is registered as experimental use `experimental<PascalName>` for programmatic options, for CLI options use `--experimental-<kebab-name>`.
