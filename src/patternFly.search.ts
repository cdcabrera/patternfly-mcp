 ...
 *
 * @note We use the logic "Is it a name match, or not a name match?" pulled from
 * general user/agent bias. Generally, users/agents respond better when results
 * contain a token queue, rather than results that are actual matches.
 *
