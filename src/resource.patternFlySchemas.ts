...
import { type PatternFlyListResourceResult } from './resource.patternFlyDocs';
import { uriCategoryComplete, uriVersionComplete } from './resource.patternFlyComponents';
 ...
 */
const URI_TEMPLATE = 'patternfly://schemas/{name}{?id,version,category}';
