...
/**
 * Load external creators, realize them, and normalize `inputSchema` in the child.
 *
 ...
 * @returns New state object with updated collection/descriptors and warnings/errors.
 */
...
/**
 * Invoke a realized collection by id. Validates arguments against the in-memory Zod schema.
 *
 * @example
